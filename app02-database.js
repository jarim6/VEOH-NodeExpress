...
app.use((req, res, next) => {
    ...
    user_model.findById(req.session._id).then((user) => {
        req.user=user;
        next();
    )};
});
...
//app.post()
const mongoose_url = 'mongodb+srv://koulu:FFMbfXTTWqnGDuND@cluster0-dmj6h.mongodb.net/test?retryWrites=true&w=majority';
//mongo user = koulu
//mongo pass = FFMbfXTTWqnGDuND
//mongodb+srv://koulu:<password>@cluster0-dmj6h.mongodb.net/test?retryWrites=true&w=majority
//mongodb+srv://koulu:FFMbfXTTWqnGDuND@cluster0-dmj6h.mongodb.net/test?retryWrites=true&w=majority
